...
public:
  ...
  size_t putFile(FILE *fp, int no, size_t offset, size_t length,
...
protected:
  ...
  int readArchiveSub(ArchiveInfo *ai, int archive_type = ARCHIVE_TYPE_SAR,
  ...
  int writeHeaderSub(ArchiveInfo *ai, FILE *fp,
                     int archive_type = ARCHIVE_TYPE_SAR, int nsa_offset = 0);
  size_t putFileSub(ArchiveInfo *ai, FILE *fp, int no, size_t offset,
                    size_t length, size_t original_length, int compression_type,
