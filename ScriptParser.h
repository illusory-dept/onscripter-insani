...
public:
  ...
  void gosubReal(const char *label, char *next_script,
                 bool textgosub_flag = false, bool pretextgosub_flag = false);
...
protected:
  ...
  bool english_mode;
#if defined(INSANI)
  bool legacy_english_mode; // 0 ... not english, 1 ... english and fixed-width
                            // and using `
  bool skip_newline_mode;   // 0 if / is not detected at end of line; 1 if / is
