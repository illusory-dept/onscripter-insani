...
public:
  ...
  enum { BLEND_NORMAL = 0, BLEND_ADD = 1, BLEND_SUB = 2, BLEND_ADD2 = 3 };
  int blending_mode;
  int cos_i, sin_i;
  ...
  void blendOnSurface(SDL_Surface *dst_surface, int dst_x, int dst_y,
                      SDL_Rect &clip, unsigned char *layer_alpha_buf,
                      int alpha = 255);
  ...
  SDL_Surface *setupImageAlpha(SDL_Surface *surface, SDL_Surface *surface_m,
                               bool has_alpha);
