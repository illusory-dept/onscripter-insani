...
#if defined(INSANI)
  void *ttf_font[8]; // 0...normal rendering, 1...outline rendering, 2...bold
                     // rendering, 3...bold outline rendering, 4...italics
                     // rendering, 5...italics outline rendering, 6...bold
                     // italics rendering, 7...bold italics outline rendering
#else
...
#if defined(INSANI)
  void *openFont(char *font_file, char *font_bold_file, char *font_italics_file,
                 char *font_bolditalics_file, bool ons_faux_bold,
                 bool ons_faux_italics, bool ons_faux_bolditalics, int ratio1,
                 int ratio2);
#else
